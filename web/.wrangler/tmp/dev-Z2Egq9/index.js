...
// src/index.js
var ArchersRoom = class {
  static {
    __name(this, "ArchersRoom");
  }
  ...
  handle(ws, role) {
    ...
    if (role === "host") {
      if (this.host) {
        try {
          this.host.close(1e3, "replaced by new host");
        } catch {
        }
      }
      this.host = ws;
...
// .wrangler/tmp/bundle-nlSF4y/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nlSF4y/middleware-loader.entry.ts
